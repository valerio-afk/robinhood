...
def _get_new_parent(sync:SynchManager, x : AbstractSyncAction) -> List[Tuple[AbstractSyncAction,AbstractSyncAction]]:
    """
    ...
    for parent in parents:
        ...
        if len(types) > 0:
            ...
            if parent.type == parent_new_action:
                ...
                new_action = SynchManager.make_action(parent.a, parent.b, parent_new_action, new_parent_direction)
