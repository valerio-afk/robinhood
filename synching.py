...
def _parse_rclone_progress(actions: List[AbstractSyncAction], sync_direction: ActionDirection,
...
class AbstractSyncAction(ABC):
    ...
    #         if (x.parent_action is None) or (x.parent_action.a.relative_path == this.a.relative_path):
