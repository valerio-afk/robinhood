...
from typing import List, Any, Union, Callable, Dict, Iterable, Tuple, AsyncIterable
...
class AbstractSyncAction(ABC):
    ...
    def __init__(this,
        ...
        this._update = None
        # this.parent_action_view:Union[SynchManager.SyncManagerView | None] = None
        # this._nested_actions: Union[SynchManager.SyncManagerView | None] = None
        this.excluded=False
    ...
    # def parent_action(this, parent: Union[SynchManager.SyncManagerView | None]) -> None:
    #     if parent is None:
    ...
    # def set_nested_actions(this, view: Union[SynchManager.SyncManagerView | None]) -> None:
    #     this._nested_actions = view
    #
    #
    # def get_nested_actions(this) -> Union[SynchManager.SyncManagerView | None]:
...
class DeleteSyncAction(AbstractSyncAction):
    ...
    async def apply_action(this, show_progress=False, eventhandler: [SyncEvent | None] = None) -> None:
        if this.excluded:
            return
...
class SynchManager():
    ...
    #
    #     def __init__(this, mng:SynchManager, keys:Union[Iterable[int] | None]):
    #         this._manager = mng
    #
    #         this._indices = set()
    #
    ...
    #
    #     @classmethod
    #     def from_actions(cls, mng:SynchManager, actions:List[AbstractSyncAction]) -> SynchManager.SyncManagerView:
    #         indices = [k for k,v in mng if v in actions]
    #
    #         return SynchManager.SyncManagerView(mng, indices)
    ...
    async def apply_changes(this, show_progress: bool = False, eventhandler: [SyncEvent | None] = None) -> None:
    ...
    # def get_nested_changes(this, action: AbstractSyncAction, *, levels=1) -> SynchManager.SyncManagerView:
    #
    ...
    #
    #     return SynchManager.SyncManagerView(this, actions_idx)
